...
/** Java API */
@ApiMayChange
abstract class PersistentBehavior[Command, Event, State >: Null] private[akka] (val persistenceId: String, supervisorStrategy: Option[BackoffSupervisorStrategy]) extends DeferredBehavior[Command] {
